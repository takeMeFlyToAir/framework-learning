...
public class JedisUtil {
    ...
    private static ShardedJedis getInstance() {
                ...
                if (INSTANCE_INIT_LOCL.tryLock(2, TimeUnit.SECONDS)) {
                    ...
                    try {
                        ...
                        if (shardedJedisPool == null) {
                            ...
                            logger.info(">>>>>>>>>>> zzr-sso, JedisUtil.ShardedJedisPool init success.");
                        }
        ...
        if (shardedJedisPool == null) {
            throw new NullPointerException(">>>>>>>>>>> zzr-sso, JedisUtil.ShardedJedisPool is null.");
        }
    ...
    public static void main(String[] args) {
        String xxlSsoRedisAddress = "redis://127.0.0.1:6379";
