...
<#macro commonHeader>
    <header class="main-header">
        <a href="${request.contextPath}/" class="logo">
            <span class="logo-mini"><b>ZZR</b></span>
            <span class="logo-lg"><b>ZZR SSO</b></span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown user user-menu">
                        <a href="${request.contextPath}/logout"   >
                            <span class="hidden-xs">注销【${zzrSsoUser.userName}】</span>
                        </a>
                    </li>
                </ul>
            </div>
...
<#macro commonFooter >
    <footer class="main-footer">
        Powered by <b>ZZR-SSO</b> 1.1.1-SNAPSHOT
    </footer>
</#macro>